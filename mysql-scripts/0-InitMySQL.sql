...
(
    ...
    AcquisitionDeviceProcessingDescription varchar(64)                              null comment '采集设备处理描述 (0018,1010) - LO, VM=1',
    AcquisitionDeviceProcessingCode        varchar(16)                              null comment '采集设备处理代码 (0018,1012) - SH, VM=1',

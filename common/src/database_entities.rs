...
impl DbProviderBase {
    ...
    pub fn extract_study_entity(
        ...
        StudyEntity {
            ...
            study_date: dicom_utils::get_date_value(dicom_obj, tags::STUDY_DATE),
            study_time: dicom_utils::get_time_value(dicom_obj, tags::STUDY_TIME),
    ...
    pub fn extract_series_entity(
        ...
        SeriesEntity {
            ...
            series_date: dicom_utils::get_date_value(dicom_obj, tags::SERIES_DATE),
            series_time: dicom_utils::get_time_value(dicom_obj, tags::SERIES_TIME),
            ...
            acquisition_time: dicom_utils::get_time_value(dicom_obj, tags::ACQUISITION_TIME),
            acquisition_date: dicom_utils::get_date_value(dicom_obj, tags::ACQUISITION_DATE),
            performing_physician_name: dicom_utils::get_text_value(
                dicom_obj,
                tags::PERFORMING_PHYSICIAN_NAME,
            ),
    ...
    pub fn extract_image_entity(
        ...
        ImageEntity {
            ...
            content_date: dicom_utils::get_date_value(dicom_obj, tags::CONTENT_DATE),
            content_time: dicom_utils::get_time_value(dicom_obj, tags::CONTENT_TIME),
